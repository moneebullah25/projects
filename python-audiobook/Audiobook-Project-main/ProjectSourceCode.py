...
photo = PhotoImage(file=r"C:\\Users\\Dell\\Downloads\\Audiobook-Project-main\\Adolf Hitler - Mein Kampf (The Stalag Edition)-Central Press of the NSDAP (1925).pdf")  # Creating a photoimage object to use image . JPEG wouldn't work here
